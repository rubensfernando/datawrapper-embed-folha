        ...
        var showModal = function() {
            ...
            $.get('/plugins/publish-embed/publish-embed.twig', function(data) {
                ...
                publish_chart(function(err) {
                    ...
                    var textileCode = 'p(artHtml5). "[{titleChart} - Crédito: Editoria de Arte/Folhapress]":{urlChart}?w={w}&h={h}',
                        htmlCode = '<iframe src="{urlChart}" frameborder="0"  allowtransparency="true"  allowfullscreen="allowfullscreen" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" oallowfullscreen="oallowfullscreen" msallowfullscreen="msallowfullscreen" width="{w}" height="{h}"></iframe> ';
